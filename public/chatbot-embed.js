(function () {
  ...
  aicReady(function () {
    ...
    aicStyle.textContent = [
      ".aic-widget{position:fixed;right:32px;bottom:36px;z-index:2147483647;font-family:Inter,-apple-system,BlinkMacSystemFont,\"Segoe UI\",sans-serif;color:#fff;transform-origin:bottom right;}",
