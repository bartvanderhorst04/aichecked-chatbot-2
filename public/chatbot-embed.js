(function () {
  ...
  aicReady(function () {
    ...
    aicStyle.textContent = [
      ".aic-widget{position:fixed;right:100px;bottom:100px;z-index:2147483647;font-family:Inter,-apple-system,BlinkMacSystemFont,\"Segoe UI\",sans-serif;color:#fff;transform-origin:bottom right;}",
