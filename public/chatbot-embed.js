(function () {
  ...
  aicReady(function () {
    ...
    aicStyle.textContent = [
      ".aic-widget{position:fixed;right:24px;bottom:24px;z-index:2147483647;font-family:Inter,-apple-system,BlinkMacSystemFont,\"Segoe UI\",sans-serif;color:#fff;}",
      ...
      "@media (max-width:420px){.aic-widget{right:14px;bottom:14px;left:14px;}.aic-launcher{width:100%;}.aic-panel{width:100%;height:min(520px,calc(100vh - 28px));}}"
    ].join("");
